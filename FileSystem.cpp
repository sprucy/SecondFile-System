...
extern DeviceDriver gc_DeviceDriver;
extern BufferManager gc_BufferManager;
extern SuperBlock gc_SuperBlock;
extern INodeTable gc_INodeTable;
extern User gc_User;
...
void FileSystem::Update() {
	...
	gc_INodeTable.UpdateINodeTable();
